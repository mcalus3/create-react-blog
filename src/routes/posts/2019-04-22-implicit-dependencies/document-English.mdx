...
import sets2 from './sets.png';
import sets3 from './sets3.png';
...
[Discuss on twitter](https://twitter.com/marek_us/) • [Edit on GitHub](https://github.com/mcalus3/create-react-blog/blob/master/src/routes/posts/2019-04-22-implicit-dependencies/document-English.mdx)
